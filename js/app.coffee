Grid =
    ...
    Generator:
        ...
        down_platform: (x_tile) ->
            for i in [1...Grid.HEIGHT_IN_TILES+1]
                if i != 2 and i != 3 and i != 4
                    Grid.put_tile Grid.generate_platform(), Grid.HEIGHT_IN_TILES - i, x_tile
            
            for i in [0..2]
                Grid.put_tile Grid.generate_yellow_platform(), Grid.HEIGHT_IN_TILES - 2, x_tile + i
        
        up_platform: (x_tile, top_gap) ->
            
            if top_gap < 2
                top_gap = 2
            
            for i in [3..Grid.HEIGHT_IN_TILES-1]
                if i > top_gap
            ...
            Grid.put_tile Grid.generate_platform(), top_gap + 2, x_tile + 1
        ...
        Frame:
            ...
            cascading_stairs_frame: () ->
                ...
                this.last_frame = 'stairs'
                this.last_frame_lowest_y += Grid.HEIGHT_IN_TILES - 1 - 5
